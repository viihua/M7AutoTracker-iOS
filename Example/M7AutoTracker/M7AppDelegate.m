...
//  M7AutoTracker
//
//  Created by DevMan7 on 12/18/2018.
//  Copyright (c) 2018 yusipeng. All rights reserved.
//
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    M7ExampleViewController *exampleViewController = [[M7ExampleViewController alloc] init];
